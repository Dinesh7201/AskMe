    ...
    // </View>
      ...
      <View style={styles.userInfoSection}>
        <View style={styles.row}>
          ...
          <Text style={{color:"#777777", marginLeft: 20}}>HYDERBAD</Text>
        </View>
        <View style={styles.row}>
          <Icon name="phone" color="#777777" size={20}/>
          <Text style={{color:"#777777", marginLeft: 20}}>8367099358o</Text>
        </View>
        <View style={styles.row}>
      ...
      <TouchableRipple onPress={() => {}}>
          <View style={styles.menuItem}>
            ...
            <Text style={styles.menuItemText}>Year                                           {myData ? myData.Year : 'Loading...'}</Text>
        ...
        <TouchableRipple onPress={() => {}}>
          <View style={styles.menuItem}>
            ...
            <Text style={styles.menuItemText}>Branch                                     {myData ? myData.Branch : 'Loading...'}</Text>
          </View>
        </TouchableRipple>
        <TouchableRipple onPress={() => {}}>
          <View style={styles.menuItem}>
            <Icon name="account-check-outline" color="#FF6347" size={25}/>
            <Text style={styles.menuItemText}>ID                                                {myData ? myData.UserRoll : 'Loading...'}</Text>
          </View>
        </TouchableRipple>
        <TouchableRipple onPress={() => {}}>
          <View style={styles.menuItem}>
